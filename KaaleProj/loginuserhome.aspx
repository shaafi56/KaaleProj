<%@ Page Title="" Language="C#" MasterPageFile="~/loginuser.Master" AutoEventWireup="true" CodeBehind="loginuserhome.aspx.cs" Inherits="KaaleProj.loginuserhome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <nav class="navbar justify-content-center fs-5 text-light">
        <ul class="nav nav-tabs">
            <li class="nav-item ">
                <a class="nav-link active" aria-current="page" href="loginuserhome.aspx">Home</a>
                </li>
                <li class="nav-item">
