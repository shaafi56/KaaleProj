<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" CodeBehind="pythonProjects.aspx.cs" Inherits="KaaleProj.pythonProjects" %>
   ...
   <nav class="navbar justify-content-center fs-5 text-light">
        <ul class="nav nav-tabs">
            <li class="nav-item ">
                ...
                <li class="nav-item">
                <a class="nav-link active" href="pythonProjects.aspx">Python</a>
                </li>
                <li class="nav-item">
    ...
    <div class="wrapper">
        <div class="mt-3 d-flex search">
            <div class="col-8"><h3>Full project using Python</h3></div>
