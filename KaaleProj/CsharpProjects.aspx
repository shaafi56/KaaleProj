<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" CodeBehind="CsharpProjects.aspx.cs" Inherits="KaaleProj.CsharpProjects" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <nav class="navbar justify-content-center fs-5 text-light">
        <ul class="nav nav-tabs">
            <li class="nav-item ">
                ...
                <li class="nav-item">
                <a class="nav-link active" href="CsharpProjects.aspx">C#</a>
                </li>
                <li class="nav-item">
    ...
    <div class="wrapper">
        <div class="mt-3 search">
            <div class="col-8"><h3>Full project using C#</h3></div>
