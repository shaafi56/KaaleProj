<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" CodeBehind="htmlcssProjects.aspx.cs" Inherits="KaaleProj.htmlcssProjects" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <nav class="navbar justify-content-center fs-5 text-light">
        <ul class="nav nav-tabs">
            <li class="nav-item ">
                ...
                <li class="nav-item">
                <a class="nav-link active" href="htmlcssProjects.aspx">HTML/CSS</a>
                </li>
                <li class="nav-item">
    ...
    <div class="wrapper">
        <div class="mt-3 d-flex search">
            <div class="col-8"><h3>Front-End Templetes (HTML,CSS)</h3></div>
        ...
        <div class="mt-5 projects">
            <div class="rounded m-2 p-2 project">
                ...
                <div class="projectDescription">
                    <h5 class="badge bg-secondary">HTML/CSS</h5>
